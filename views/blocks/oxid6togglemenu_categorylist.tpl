[{block name="sw_widget_header_categorylist"}]
...
[{if $oxcmp_categories}]
    ...
    <nav id="mainnav1" class="navbar navbar-expand-lg navbar-light[{if $blFullwidth}] fullviewlayout[{/if}]" role="navigation">
        <div class="container">
            ...
            [{/block}]
            <div class="collapse navbar-main-collapse" id="navbarSupportedContent">
                <ul id="navigation1" class="navbar-nav nav">
