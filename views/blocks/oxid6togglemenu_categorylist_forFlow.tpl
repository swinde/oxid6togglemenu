[{block name="sw_widget_header_categorylist"}]
    ...
    <nav id="mainnav1" class="navbar navbar-default [{if $blFullwidth}]fullviewlayout[{/if}]" role="navigation">
        <div class="[{if $blFullwidth}]container[{else}]container-fluid[{/if}]">
            ...
            <div class="collapse navbar-collapse1 navbar-ex1-collapse">
                <ul id="navigation1" class="nav navbar-nav">
